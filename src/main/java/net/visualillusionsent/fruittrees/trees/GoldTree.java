...
public final class GoldTree extends FruitTree {
    ...
    public GoldTree(FruitTrees fruit_trees, int loc_x, int loc_y, int loc_z, TreeWorld world, boolean isPlanting) {
        super(fruit_trees, TreeType.GOLD, loc_x, loc_y, loc_z, world, isPlanting);
    }
